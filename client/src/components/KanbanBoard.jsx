...
const handleTaskCreated = (newTask) => {
  console.log('handleTaskCreated called with:', newTask.title);
  setTasks((prev) => {
  ...
  <div style={{ marginBottom: '20px' }}>
    <button
      ...
      style={{ padding: '10px 20px', background: '#6c63ff', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600' }}
    >
      + Add Task
    </button>
  </div>
